...
export EPHER_MIXNET_RELAY_BIND="${EPHER_MIXNET_RELAY_BIND:-127.0.0.1}"
export EPHER_MIXNET_RELAY_PORT="${EPHER_MIXNET_RELAY_PORT:-9797}"
export EPHER_MIXNET_PROVIDER_BIND="${EPHER_MIXNET_PROVIDER_BIND:-127.0.0.1}"
export EPHER_MIXNET_PROVIDER_PORT="${EPHER_MIXNET_PROVIDER_PORT:-9798}"
export EPHER_MIXNET_PROVIDER_URL="${EPHER_MIXNET_PROVIDER_URL:-http://127.0.0.1:${EPHER_MIXNET_PROVIDER_PORT}/provider}"
